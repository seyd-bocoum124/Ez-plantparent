...
import usecases.ManageStations.SendCommand.Controller as controller_module
...
class TestUpdateStationController:
    class TestWhenUpdateOk:
        def test_returns_200_and_calls_repository_with_correct_station(
            ...
            monkeypatch.setattr(controller_module, "Repository", FakeRepository)
            ...
            # On vérifie que le repo et la station ont bien été créés
    ...
    class TestWhenRepositoryRaises:
        def test_returns_500_when_update_fails(
            ...
            monkeypatch.setattr(controller_module, "Repository", FailingRepository)
