...
from entities.models import MaintenanceSheet, User, RefreshToken


class TestMaintenanceSheetCreation:
    def test_when_only_one_maintenance_sheet_exist_should_return_it(self, client, repo: Repository, user: User):
        # Arrange
        ...
        # Act
        resp = client.get(f"api/maintenance-sheets/{sheet_id}")
